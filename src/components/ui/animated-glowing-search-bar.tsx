...
export const AnimatedGlowingBorder = ({
  ...
  return (
    <div className={cn("relative group w-full", className)}>
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden rounded-xl blur-[3px]
                        before:absolute before:content-[''] before:z-0 before:w-[999px] before:h-[999px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-60
      ...
      <div className="pointer-events-none absolute inset-[1px] z-0 overflow-hidden rounded-xl blur-[3px]
      ...
      <div className="pointer-events-none absolute inset-[3px] z-0 overflow-hidden rounded-lg blur-[2px]
      ...
      <div className="pointer-events-none absolute inset-[5px] z-0 overflow-hidden rounded-lg blur-[0.5px]
                        before:absolute before:content-[''] before:z-0 before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-70
      ...
      <div className={cn("relative z-10 w-full rounded-lg bg-[#010201]", innerClassName)}>
        {children}
      </div>
    </div>
  );
