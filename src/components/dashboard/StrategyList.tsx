...
export function StrategyList({
  ...
  return (
    <div className="space-y-4">
      {items.map((item) => (
        <Card key={item.id} className="bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl rounded-3xl transition-all hover:border-white/20 hover:bg-white/8">
